...
let s:N1   = [ '#008787' , '#ffffff' , 030, 231 ]
let s:N2   = [ '#080808' , '#ffffff' , 232, 231 ]
let s:N3   = [ '#080808' , '#ffffff' , 232, 231 ]
...
let g:airline#themes#edocx#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#ffffff' , 231     , 231, ''     ] ,
      \ }


let s:I1 = [ '#5f8787' , '#ffffff' , 066, 231  ]
let s:I2 = [ '#080808' , '#ffffff' , 232, 231  ]
let s:I3 = [ '#080808' , '#ffffff' , 232, 231  ]
...
let s:V1 = [ '#005f87' , '#ffffff' , 024, 231  ]
let s:V2 = [ '#080808' , '#ffffff' , 232, 231  ]
let s:V3 = [ '#080808' , '#ffffff' , 232, 231  ]
...
let s:IA1 = [ '#bcbcbc' , '#ffffff' , 250 , 231 , '' ]
let s:IA2 = [ '#bcbcbc' , '#ffffff' , 250 , 231 , '' ]
let s:IA3 = [ '#bcbcbc' , '#ffffff' , 250 , 231 , '' ]
...
let g:airline#themes#edocx#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#008787' , '#ffffff' , 030, 231, '' ],
      \ [ '#008787' , '#ffffff' , 030, 231, ''     ],
      \ [ '#008787' , '#ffffff' , 030, 231, 'bold' ])
